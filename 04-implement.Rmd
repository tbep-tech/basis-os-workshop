...
<h4>`r fa('exclamation-circle')` Challenge</h4> 
...
Although it's true that adopting new tools will slow forward progress, this is only temporary.  Consider your path towards learning new platforms as an investment in your future.  The immediate benefit may not be apparent, but you'll soon wonder how you ever got by before.  
...
<h3>`r fa('hat-wizard')` Discussion</h3>
...
*Being open makes me nervousgit stat!*
...
Maybe there are legal contexts to being open.  For example, Florida has "sunshine laws" that obligates all communications at public insitutions as public record.  What does this mean for using new workflows in open science?  Is this is an improvement or a liability (see [previous section](#fear-of-exposure))? 
...
What are some simple things you can do to beging adopting open science?  