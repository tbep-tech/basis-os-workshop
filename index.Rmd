...
* \@ref(basics): [The basics of open science](#basics) (__30 min__)
* \@ref(collaborate): [Open science for collaboration](#collaborate) (__90 min__)
* \@ref(impact): [Open science for impactful products](#impact) (__90 min__)
* \@ref(implement): [Lowering barriers to inclusion and addressing key critiques](#implement) (__30 min__)
...
<h4>`r fa('hat-wizard')` Exercise or discussion</h4>
...
<h4>`r fa('exclamation-circle')` Challenge to overcome for using open science</h4> 
